...
ListJadwalModel listJadwalModelFromJson(String str) =>
    ListJadwalModel.fromJson(json.decode(str));

String listJadwalModelToJson(ListJadwalModel data) =>
...
class ListJadwalModel {
  ...
  factory ListJadwalModel.fromJson(Map<String, dynamic> json) =>
      ListJadwalModel(
        message: json["message"],
        data: json["data"] == null
            ? []
            : List<JadwalModel>.from(
                json["data"]!.map((x) => JadwalModel.fromJson(x))),
      );
